...
import { createProduct, bulkUploadProducts, getCompanyProducts, getBulkRequests, handleBulkRequest, generateProductsAdmin } from '../controllers/productController';
...
router.post('/admin/generate', authenticate as any, authorize(['ADMIN']), generateProductsAdmin as any);
